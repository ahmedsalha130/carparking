...
<style>
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            ...
            {!! Form::model($customer, ['route' => ['customer.update', $customer->id], 'method' => 'patch', 'files' => true]) !!}

            <div class="row">
                <div class="col-3">
                    <div class="form-group">
                        {!! Form::label('name', 'Name') !!}
                        {!! Form::text('name', old('name',$customer->name), ['class' => 'form-control']) !!}
                ...
                <div class="col-3">
                    <div class="form-group">
                        ...
                        {!! Form::text('email', old('email',$customer->email), ['class' => 'form-control']) !!}
            ...
            <div class="row">
                ...
                <div class="col-3">
                    <div class="form-group">
                        ...
                        {!! Form::select('status', ['' => '---', '1' => 'active', '0' => 'Inactive', ],old('status',$customer->status), ['class' => 'form-control']) !!}
                ...
                <div class="col-3">
                    <div class="form-group">
                        ...
                        {!! Form::select('near', ['' => '---', '1' => 'active', '0' => 'Inactive', ],old('near',$customer->near), ['class' => 'form-control']) !!}
