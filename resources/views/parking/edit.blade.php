        ...
        <div class="col-lg-4">
            <div class="page-header-breadcrumb">
                <ul class="breadcrumb-title">
                    ...
                    <li class="breadcrumb-item" style="float: left;"><a href="#!">Slot</a>
                    </li>
                ...
                <div class="row">
                    ...
                    <div class="col-3">
                        <div class="form-group timepicker">
                            ...
                            {!! Form::text('start_time_sensor', old('start_time_sensor',$park->start_time_sensor), ['class' => 'form-control icons','readonly']) !!}
                    ...
                    <div class="col-3">
                        <div class="form-group timepicker">
                            ...
                            {!! Form::text('end_time_sensor', old('end_time_sensor',$park->end_time_sensor), ['class' => 'form-control','readonly']) !!}
