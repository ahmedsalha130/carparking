...
{{--                                        <a  href="#edit_status" data-id_wallet="{{ $wallet->id }}" data-wallet_number ="{{$wallet->number}}" data-status_wallet ="{{$wallet->status}}"   data-effect="effect-scale" data-toggle="modal" class="dropdown-item waves-light waves-effect" > <li class="icofont icofont-arrow-right"> Status</li></a>--}}
                                        <a  class="dropdown-item waves-light waves-effect" href="#resotre_wallet"  data-id_wallet="{{$wallet->id  }}" data-wallet_number ="{{$wallet->number}}"
                                            data-effect="effect-scale" data-toggle="modal" >
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <form method="POST" id="add-form" action= "{{route('PaymentWallet_Archive.destroy',1)}}">
                                @csrf
                                {{method_field('delete')}}
                                <div class="form-group">
            ...
            <div class="modal fade" id="resotre_wallet"  tabindex="-2" role="dialog" aria-labelledby="exampleModalLabel"
                 aria-hidden="true">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLabel">Restore PaymentWallet</h5>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
                        <div class="modal-body">
                            ...
                            <form method="POST" id="add-form" action= "{{route('PaymentWallet_Archive.update','update')}}">
                                @csrf
                                {{ method_field('patch') }}
                                <div class="form-group">
                                    <div class="file-field input-field">
                                        <div class="btn">
                                            <h6 style="color:red" >Move the PaymentWallet to the list PaymentWallet?</h6>


                                            <input type="hidden" name="id_wallet" id="id_wallet" value="">

                                            <input type="text" disabled   name="wallet_number" value="" id="wallet_number" >
...
@section('script')
    ...
    <script>
        ...
        $('#resotre_wallet').on('show.bs.modal', function(event) {
