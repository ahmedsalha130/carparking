                    ...
                    <form method="POST" action="{{ route('admin.login') }}" class="md-float-material form-material">
                        ...
                        <div class="auth-box card">
                            <div class="card-block">
                                ...
                                <div class="form-group form-primary">
                                    <input type="password" name="password" id="myInput" class="form-control @error('password') is-invalid @enderror" required="" autocomplete="current-password" placeholder="Password">
                                    @error('password')
                                    <span class=" form-bar invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                                ...
                                <div class="row m-t-25 text-left">
                                    <div class="col-12">
                                        <div class="checkbox-fade fade-in-primary d-">
                                            <label>
                                                <input type="checkbox"   name="remember" onclick="myFunction()"  id="remember" {{ old('remember') ? 'checked' : '' }}>
...
{{--                            <div class="col-md-6">--}}
{{--                                <input id="password"  type="password" id="myInput" class="form-control @error('password') is-invalid @enderror" name="password" required autocomplete="current-password">--}}
...
{{--                                    <input class="form-check-input" type="checkbox" onclick="myFunction()" name="remember" id="remember" {{ old('remember') ? 'checked' : '' }}>--}}
